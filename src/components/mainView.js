  ...
  const changeLanguage=(language)=>{
    ...
    const getInfo=()=>{
      ...
      const arr = [
        ...
        {id:4,name:t("name4"),image:"../Images/zverev.jpg",tema:"drama",years:t("year4"),description:t("descmain4"),tube:"https://www.youtube.com/embed/tII7PrWmrnc?si=DzsBfqeKiyAs3nR5",img1:"../Images/zverev1.jpg",img2:"../Images/zverev2.jpg",img3:"../Images/zverev3.jpg",hist1:t("hist41"),hist2:t("hist42"),hist3:t("hist43"),hist4:t("hist44")},
